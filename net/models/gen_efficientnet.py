...
try:
    ...
    from net.models.helpers import load_pretrained
    from net.models.adaptive_avgmax_pool import SelectAdaptivePool2d
    from net.models.conv2d_same import sconv2d
...
def hard_sigmoid(x):
    ...
    return F.relu6(x + 3.) * (1. / 6.)
# SIGMOID = hard_sigmoid

def swish(x):
    return F.relu(x)
    # return (x * (1. / 6.)) * F.relu6(x + 3.)
...
class SqueezeExcite(nn.Module):
    ...
    def forward(self, x):
        ...
        # x_se = x.mean(2, True).mean(3, True)
...
def tf_efficientnet_b6(num_classes, in_chans=3, pretrained=False, **kwargs):
    """ EfficientNet-B4. Tensorflow compatible variant """
...
def tf_efficientnet_b7(num_classes, in_chans=3, pretrained=False, **kwargs):
    """ EfficientNet-B4. Tensorflow compatible variant """
